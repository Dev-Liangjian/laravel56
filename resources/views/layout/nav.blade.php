<div class="blog-masthead">
    <div class="container">
        <ul class="nav navbar-nav navbar-left">
            ...
            <li>
                <input name="query" id="query" type="text" class="form-control" style="margin-top:10px" placeholder="关键词">
            </li>
            <li>
        ...
        <ul class="nav navbar-nav navbar-right">
            <li class="dropdown">
                <div>
                    <img src="{{asset('storage/' . Auth::user()->avatar)}}" alt="" class="img-rounded" style="border-radius:500px; height: 30px">
